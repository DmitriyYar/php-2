...
use Geekbrains\Php2\Blog\Command\Arguments;
use Geekbrains\Php2\Blog\Command\CreateUserCommand;
...
//    $command->handle(Arguments::fromArgv($argv)); // php cli_.php username=Admin first_name=Ivan last_name=Ivanov
